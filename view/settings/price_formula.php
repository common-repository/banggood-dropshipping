<?php
$b2wl_pricing_rules_type = b2wl_get_setting('pricing_rules_type', 'sale_price_as_base');  
$b2wl_use_extended_price_markup = b2wl_get_setting('use_extended_price_markup');
$b2wl_use_compared_price_markup = b2wl_get_setting('use_compared_price_markup');
...
<div class="global-pricing mt20">
    <div class="panel panel-primary">
        ...
        <div class="panel-body p20 border-bottom js-default-prices"  <?php if ($b2wl_use_extended_price_markup): ?>style="display: none;" <?php else: ?>style="display: block;"<?php endif; ?>>
            ...
            <div class="row pb20 border-bottom">
                ...
                <div class="col-sm-3 col-md-3 vertical-align">
                    <div class="input-group price-dropdown-group">
                        <input type="text" sign="<?php echo esc_attr($default_formula->sign); ?>" class="form-control value" value="<?php echo esc_attr($default_formula->value); ?>">
            ...
            <div class="row pt20 compared">
                <div class="col-sm-1 vertical-align">   
                    <div class="price-rulle-toggle <?php if (!$b2wl_use_compared_price_markup): ?>price-rulle-toggle--disabled<?php endif; ?>"></div>
                </div>

                <div class="col-sm-10 vertical-align switch-col" <?php if ($b2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                    <span class="grey-color" style="">Set your compared at pricing rules</span>
                </div> 
                <div class="col-sm-2 vertical-align switch-col" <?php if (!$b2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                    <h3>Product cost</h3>
                </div>                            
                <div class="col-sm-3 col-md-3 vertical-align switch-col" <?php if (!$b2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                    <div class="input-group price-dropdown-group">

                        <input type="text" sign="<?php echo esc_attr($default_formula->compared_sign); ?>" value="<?php echo esc_attr($default_formula->compared_value); ?>" class="form-control compared_value">
                ...
                <div class="col-sm-1 vertical-align switch-col" <?php if (!$b2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
                    <svg class="icon-full-arrow-right">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-full-arrow-right"></use>
                    </svg>
                </div>
        ...
        <div class="p20 extended_prices">
            <div class="container-flex">
                <div class="price-rulle-toggle <?php if (!$b2wl_use_extended_price_markup): ?>price-rulle-toggle--disabled<?php endif; ?>"></div>
                <div>
            ...
            <div class="js-advanced-prices mt20" <?php if (!$b2wl_use_extended_price_markup): ?>style="display: none;" <?php else: ?>style="display: block;"<?php endif; ?>>
                    ...
                    <table class="border">
                        <thead>
                            <tr class="border-bottom">
                                ...
                                <th width="25%" style="white-space: nowrap;">
                                    <input class="use_compared_price_markup" type="checkbox" <?php if ($b2wl_use_compared_price_markup): ?>checked="checked"<?php endif; ?>><span>Regular price markup</span>
                                </th>
                                <th>&nbsp;</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="border-bottom">
                                    <td>
                                        <div class="input-group">        
                                            <input type="text" class="form-control min_price" value="<?php echo esc_attr($formula->min_price); ?>"><span class="input-group-addon"> <?php echo esc_html($b2w_local_currency);?> </span>
                                        </div>
                                    </td>
                                    <td>-</td>
                                    <td>
                                        <div class="input-group">        
                                            <input type="text" class="form-control max_price" value="<?php echo esc_attr($formula->max_price); ?>"><span class="input-group-addon"> <?php echo esc_html($b2w_local_currency);?> </span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group price-dropdown-group">
                                            <input type="text" sign="<?php echo esc_attr($formula->sign); ?>" class="form-control value" value="<?php echo esc_attr($formula->value); ?>">
                                    ...
                                    <td>
                                        <div class="input-group price-dropdown-group <?php if (!$b2wl_use_compared_price_markup): ?>visually-hidden<?php endif; ?>">
                                            <input type="text" sign="<?php echo esc_attr($formula->compared_sign); ?>" class="form-control compared_value" value="<?php echo esc_attr($formula->compared_value); ?>">
                        ...
                        <tfoot>
                            <tr class="border-bottom">
                                ...
                                <td>
                                    <div class="input-group price-dropdown-group">
                                        <input type="text" sign="<?php echo esc_attr($default_formula->sign); ?>" class="form-control default_value" value="<?php echo esc_attr($default_formula->value); ?>">
                                ...
                                <td>
                                    <div class="input-group price-dropdown-group <?php if (!$b2wl_use_compared_price_markup): ?>visually-hidden<?php endif; ?>">
                                        <input type="text" sign="<?php echo esc_attr($default_formula->compared_sign); ?>" value="<?php echo esc_attr($default_formula->compared_value); ?>" class="form-control default_compared_value">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-10">
                        <div class="input-wrap" <?php if (!$b2wl_use_compared_price_markup): ?>style="display:none;"<?php endif; ?>>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel__header-title"><?php echo esc_html_e('Add shipping cost', 'bng2woo-lite'); ?></h3>
        </div>
        ...
        <div class="panel-body _b2wfv">
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="grey-color mb20"><?php echo esc_html_e('You can add the shipping cost that you see in the import list to the product price.', 'bng2woo-lite'); ?></div>
                </div>
            </div>

            <div class="row">
                <div class="col-md-4">
                    <label for="b2wl_add_shipping_to_price">
                        <strong><?php echo esc_html_e("Add shipping cost to product price", 'bng2woo-lite'); ?></strong>
                    </label>
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_e("Shipping costs will be added to the product price.", 'bng2woo-lite'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
                        <input type="checkbox" class="form-control" id="b2wl_add_shipping_to_price" name="b2wl_add_shipping_to_price" value="yes" <?php if (b2wl_get_setting('add_shipping_to_price')): ?>checked<?php endif; ?>/>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <label for="b2wl_apply_price_rules_after_shipping_cost">
                        <strong><?php echo esc_html_e("Add shipping cost first and then apply the price rules", 'bng2woo-lite'); ?></strong>
                    </label>
                    <div class="info-box" data-toggle="tooltip" title="<?php echo esc_html_e("Pricing rules will be applied after shipping cost are added to the product price. This is necessary if you want to add a markup to both the product cost and the shipping cost.", 'bng2woo-lite'); ?>"></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group input-block no-margin">
                        <input type="checkbox"<?php if (!b2wl_get_setting('add_shipping_to_price')): ?> disabled="disabled"<?php endif; ?> class="form-control" id="b2wl_apply_price_rules_after_shipping_cost" name="b2wl_apply_price_rules_after_shipping_cost" value="yes" <?php if (b2wl_get_setting('apply_price_rules_after_shipping_cost')): ?>checked<?php endif; ?>/>
                    </div>
                </div>
            </div>
...
<div class="container-fluid">
    <div class="row pt20 border-top">
        <div class="col-sm-12">
            <input class="btn btn-success mt20" type="submit" id="save-price-rules" value="<?php _e('Save settings', 'bng2woo-lite'); ?>"/>
        </div>
    </div>
</div>
...
<script>
    ...
    jQuery(function ($) {
        $("#b2wl_pricing_rules_type").change(function () {
            $('#pricing_rules_type_description').html(pricing_rules_types[$(this).val()].description);
        });

        $("#b2wl_add_shipping_to_price").change(function () {
            $("#b2wl_apply_price_rules_after_shipping_cost").prop('disabled', !$(this).is(':checked'));
        });
        ...
        function b2wl_apply_pricing_rules(type, scope, _this_btn){
            ...
            if(scope=='all' || scope=='import'){
                b2wl_apply_import_pricing_rules(type, 0, function (state, message) {
                    if(state!=='ok'){
                        show_notification(message, true);
                    }else{
                        if(scope=='all'){
                            b2wl_apply_shop_pricing_rules(type, 0, on_done_calback);
                        }else{
                            show_notification('Applying pricing rules to your existing products');
                            $(".modal-apply-pricing-rules").removeClass('opened');
                            $(_this_btn).removeAttr("disabled");
        ...
        function b2wl_apply_import_pricing_rules(type, page, on_done_calback){
            var data = {'action': 'b2wl_apply_pricing_rules', 'type':type,'scope':'import', 'import_page':page};
            jQuery.post(ajaxurl, data).done(function (response) {
                var json = jQuery.parseJSON(response);
                if(json.state==='ok'){
                    $(".modal-apply-pricing-rules .status").html(json.info);
                    if(json.done===0){
                        b2wl_apply_import_pricing_rules(type, page+1, on_done_calback);
                    }else{
                        if(on_done_calback){
        ...
        function b2wl_apply_shop_pricing_rules(type, page, on_done_calback){
            var data = {'action': 'b2wl_apply_pricing_rules', 'type':type,'scope':'shop', 'page':page};
            jQuery.post(ajaxurl, data).done(function (response) {
                var json = jQuery.parseJSON(response);
                if(json.state==='ok'){
                    $(".modal-apply-pricing-rules .status").html(json.info);
                    if(json.done===0){
                        b2wl_apply_shop_pricing_rules(type, page+1, on_done_calback);
                    }else{
                        if(on_done_calback){
                            on_done_calback(json.state, '');
                        }
        ...
        $(".modal-apply-pricing-rules .apply-btn").on("click", function () {
            ...
            b2wl_apply_pricing_rules(type, scope, _this_btn);
        ...
        $(".js-default-prices div.info-box").on("mouseover", function () {
            $(this).attr('title', rule_info_box_calculation("E.g., A product that costs %d <?php echo esc_js($b2w_local_currency);?> would have its price set to %d <?php echo esc_js($b2w_local_currency);?> (%d %s %d = %d).", get_el_sign_value($('.js-default-prices ul.sign')), get_value()));
            if(jQuery.fn.tooltip) { $(this).tooltip('fixTitle').tooltip('show'); }
        });

        $(".js-default-prices .compared div.info-box").on("mouseover", function () {
            $(this).attr('title', rule_info_box_calculation("If you import a product that costs %d <?php echo esc_js($b2w_local_currency);?>, we'll set its compared at price to %d <?php echo esc_js($b2w_local_currency);?> (%d %s %d = %d).", get_el_sign_value($('.js-default-prices ul.compared_sign')), get_value(true)));
            if(jQuery.fn.tooltip) { $(this).tooltip('fixTitle').tooltip('show'); }
        });
            ...
            if (use_extended_price_markup) {
                ...
                if (check_price_rules()) {
                    ...
                    if ($('.js-advanced-prices table .input-group.has-error').length === 0) {
                        if (check_cents()) {
                            var data = {'action': 'b2wl_update_price_rules', 
                                ...
                                'add_shipping_to_price': $('#b2wl_add_shipping_to_price').is(":checked")?1:0,
                                'apply_price_rules_after_shipping_cost': $('#b2wl_apply_price_rules_after_shipping_cost').is(":checked")?1:0
                            };
                ...
                if ($('.js-default-prices .input-group.has-error').length === 0) {
                    ...
                    if (check_cents()) {
                        var data = {'action': 'b2wl_update_price_rules',
                            ...
                            'add_shipping_to_price': $('#b2wl_add_shipping_to_price').is(":checked"),
                            'apply_price_rules_after_shipping_cost': $('#b2wl_apply_price_rules_after_shipping_cost').is(":checked")
                        };                                                
                        jQuery.post(ajaxurl, data).done(function (response) {
                            show_notification('Saved successfully.');
                            var json = jQuery.parseJSON(response);
