...
/**
 * Description of B2WL_Utils
 *
 * @author Andrey
 */
if (!class_exists('B2WL_Utils')) {
    ...
    class B2WL_Utils
    {
        ...
        {
            return is_plugin_active('woocommerce_banggood_shipment_tracking/index.php');
        }
        ...
        public static function delete_post_images($post_id)
        {
            ...
            if ($external_id || $post_type == 'product_variation') {
                ...
                if ($thumbnail_id && $post_type != 'product_variation') {
                    B2WL_Utils::delete_attachment($thumbnail_id, true);
                }
            }
        }
        ...
        {
            if (b2wl_check_defined('B2WL_USE_DEFAULT_DELETE_ATTACHMENT')) {
        ...
        public static function get_all_images_from_product($product, $skip = false, $product_images = true, $description_images = true)
        {
            ...
            if ($description_images && !empty($product['description'])) {
                $desc_images = B2WL_Utils::get_images_from_description($product['description']);
        ...
        public static function safeTransliterate($text)
        {
            ...
            $cyr = array(
                ...
                'Ж', 'Ч', 'Щ', 'Ш', 'Ю', 'А', 'Б', 'В', 'Г', 'Д', 'Е', 'З', '�?', 'Й', 'К', 'Л', 'М', 'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Ф', 'Х', 'Ц', 'Ъ', 'Ь', 'Я');
            $lat = array(
            ...
            static $translit = array(
                ...
                'd' => '/[ÐĎḊḌḎḐḒďḋḍḏḑḓð]/u',
                'e' => '/[ÈËĒĔĖ�?ĚȄȆȨḔḖ�?ḚḜẸẺẼẾỀỂỄỆèëēĕėęěȅȇȩḕḗḙḛḝẹẻẽếềểễệ]/u',
                ...
                'o' => '/[ÒÖŌŎŐƠǑǪǬȌȎȪȬȮȰṌṎṐṒỌỎỐỒỔỖ�?ỚỜỞỠỢ�?Ǿòöōŏőơǒǫǭȍȏȫȭȯȱṍṏṑṓọỏốồổỗộớờởỡợøǿ]/u',
                'p' => '/[ṔṖṕṗ]/u', 'r' => '/[ŔŖ�?ȐȒ�?ṚṜṞŕŗřȑȓṙṛṝṟ]/u',
                's' => '/[ŚŜŞŠ�?ṠṢṤṦṨſśŝşšșṡṣṥṧṩ]/u', 'ss' => '/[ß]/u',
                't' => '/[ŢŤȚṪṬṮṰţťțṫṭṯṱẗ]/u', 'th' => '/[Þþ]/u',
                'u' => '/[ÙŨŪŬŮŰŲƯǓȔȖṲṴṶṸṺỤỦỨỪỬỮỰùũūŭůűųưǔȕȗṳṵṷṹṻụủứừửữựµ]/u',
                'v' => '/[ṼṾṽṿ]/u', 'w' => '/[ŴẀẂẄẆẈŵẁẃẅẇẉ�?]/u',
